...
variable "log_group_tags" {
  description = "A mapping of tags to assign to the log group"
  type        = map(string)
  default     = {}
}
variable "kms_tags" {
  description = "A mapping of tags to assign to the kms_key"
  type        = map(string)
  default     = {}
}
...
variable "eks_cluster_role_arn" {
  type        = string
  description = "The ARN of the role to be attached to the EKS cluster"
  default = ""
}
...
variable "eks_security_group_ids" {
  type        = list(string)
  default     = []
  description = "List of Security Group IDs to be attached to the EKS cluster"
}
...
variable "clustername" {
  type        = string
  default     = ""
  description = "name of the cluster for the provider"
}
